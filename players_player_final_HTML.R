...
data <- read_excel("321s_final.xlsx")   # or readRDS("data.rds")
...
# season totals: same columns as totals_round, minus Round
...
ui <- fluidPage(
  ...
  tags$div(
    ...
    HTML("Created by Brooke Harvey using <em>ggplot2</em> and <em>shiny</em> in R.
          Last updated 7 September 2026 04:16:55 AEST.<br>
          For data queries and code, contact
          <a href='mailto:brooke.harvey@newcastle.edu.au'>brooke.harvey@newcastle.edu.au</a>.")
  ))
